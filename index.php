...
<html lang="es">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Acceso | J&D - Justicia & Derecho</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index-1.html" class="d-block auth-logo">
                                            <img src="assets/picture/logo-sm-1.svg" alt="" height="28"> <span class="logo-txt">J&D - Justicia & Derecho</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        ...
                                        <form class="custom-form mt-4 pt-2">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" id="usu_correo" placeholder="Ingrese Correo Electronico">
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group auth-pass-inputgroup">
                                                    <input type="password" class="form-control" placeholder="Ingrese la contraseña" aria-label="Password" aria-describedby="password-addon">
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                ...
                                                                <div class="flex-grow-1 ms-3 mb-4">
                                                                    <h5 class="font-size-18 text-white">Aldo Carhuallanqui
                                                                    </h5>
